...
public class MainActivity extends AppCompatActivity {
        ...
        if (button != null){
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dialog.setMessage("Choose the button for what you would like to see");
    ...
    private void showListDialog() {
        ...
        dialog_list.setTitle("Use List to show");
        dialog_list.setItems(list_item, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int i) {
                        Toast.makeText(MainActivity.this, "You chose" + list_item[i], Toast.LENGTH_SHORT).show();
                    }
                });
                dialog_list.show();
    }
